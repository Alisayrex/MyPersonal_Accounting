        ...
        private void btnDeleteCustomer_Click(object sender, EventArgs e)
        {
            ...
            if (dgvCustomers.CurrentRow != null)
            {
                using (UnitOfWork db = new UnitOfWork())
                {
                    ...
                    if (MessageBox.Show($"آیا از حذف {name} مطمئین هستید ؟ ", "توجه", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                    {
            ...
            {
                MessageBox.Show($"لطفا یک شخص را انتخاب کنید !","توجه" , MessageBoxButtons.OK , MessageBoxIcon.Error);
            }
